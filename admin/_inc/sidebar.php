<div class="sidebar hidden-xs">
	...
	<div class="h20"></div>
		...
		<p><b>Dün: </b><span class="text-primary"><?php echo orders_reporting(array( 'start_date'=>date('Y-m-d', strtotime('0 day',strtotime(date('Y-m-d')))).' 00:00:00', 'end_date'=>date('Y-m-d', strtotime('0 day',strtotime(date('Y-m-d')))).' 99:99:99' )); ?> Sipariş</span></p>
