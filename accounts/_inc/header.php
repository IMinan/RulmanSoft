...
<head>
	...
	<!-- favicon -->
	<link rel="icon" href="<?php echo account_url('img/favicon.ico'); ?>" type="image/ico"/>

	<!-- bootstrap -->
	<script src="<?php echo account_url('js/jquery.min.js'); ?>"></script>
	<script src="<?php echo account_url('js/validation.js'); ?>"></script>
	<link rel="stylesheet" href="<?php echo account_url('css/bootstrap.min.css'); ?>">
	<script src="<?php echo account_url('js/bootstrap.min.js'); ?>"></script>

	<!-- fontawesome -->
	<link rel="stylesheet" href="<?php echo account_url('css/font-awesome.min.css'); ?>">

	<!-- datatable -->
	<link rel="stylesheet" type="text/css" href="<?php echo account_url('css/datatables.min.css'); ?>"/>
 	<script type="text/javascript" src="<?php echo account_url('js/datatables.min.js'); ?>"></script>
...
<div class="container bg">
						...
						<li class="dropdown"><a href="#" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
							...
							<?php echo active_user('display_name'); ?>  <span class="caret"></span></a>
  							<ul class="dropdown-menu">
  								<li><a href="<?php echo account_url('index.php'); ?>" title="Profilim"><i class="fa fa-folder-open"></i> Yönetim Paneli</a></li>
                	<li role="separator" class="divider"></li>
                	<li><a href="<?php echo account_url('edit_profile.php'); ?>" title="Profilim"><i class="fa fa-user"></i> Profilim</a></li>
                	<li><a href="<?php echo account_url('message_inbox.php'); ?>"><i class="fa fa-envelope"></i> Mesaj Kutusu</a></li>
                	<li><a href="#"><i class="fa fa-cog"></i> Ayarlar</a></li>
                	<li role="separator" class="divider"></li>
                	<li><a href="<?php echo account_url('logout.php'); ?>"><i class="fa fa-power-off"></i> Çıkış Yap</a></li>
                </ul>
						</li>
					</ul> <!-- /.top-menu -->
				<?php else: ?>
					<ul class="top-menu">
						<li><a href="<?php echo account_url('login.php'); ?>">Giriş Yap</a></li>
						<li><a href="<?php echo account_url('login.php'); ?>">Üye Ol</a></li>
					</ul> <!-- /.top-menu -->
				<?php endif; ?>
			</div> <!-- /.col-md-6 -->
		</div>
	...
	<div class="rl-menu">
			...
			<ul>
				<li><a href="<?php echo account_url(''); ?>" title="Rulman Listesi Anasayfa" class="active"><i class="fa fa-desktop"></i> Yönetim Paneli</a></li>
				<li><a href="<?php echo account_url(''); ?>" title="Web Sitesi" class="hidden-xs hidden-sm"><i class="fa fa-sitemap"></i> Siparişlerim</a></li>
