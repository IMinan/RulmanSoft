...
<div class="row">
  ...
  <div class="col-md-6">
    <form action="" method="post" class="login-register validate">
      ...
      <div class="form-group">
        <input type="submit" name="submit" value="Gönder" class="btn btn-success required"> <span style="margin-top: 25px;" class="pull-right m-none"> Sitemize üyeliğiniz var mı? <a href="<?php echo account_url('login.php'); ?>">Üye giriş paneli</a>.</span>
      </div><!--/ .form-group /-->
    </form>
  </div><!--/ .col-md-6 /-->
